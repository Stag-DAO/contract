...
contract sSTAG is ERC20Permit, Ownable {
    ...
    constructor() ERC20("sStag", "sSTAG", 9) ERC20Permit() {
    ...
    /**
        @notice increases sStake supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sStag
